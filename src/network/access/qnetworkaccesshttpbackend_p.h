...
private slots:
    ...
    void finished(); // override
	 void reorderFile(const QAbstractNetworkCache *nc); /*[sslab cache]*/
...
#ifdef SSLAB_SR
	void validateCache(QHttpNetworkRequest &httpRequest, bool &loadedFromCache, const bool estimatingTime, const int sr_flag);
#endif
