...
//	 QWebSettings::globalSettings()->setAttribute(QWebSettings::DeveloperExtrasEnabled, true); //sslab.replay
	 QWebSettings::setMaximumPagesInCache(0);				//sslab.replay
	 QWebSettings::setObjectCacheCapacities(0,0,0);		//sslab.replay
