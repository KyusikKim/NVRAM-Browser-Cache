...
//      , maximumCacheSize(1024 * 1024 * 50) //50MB (default at QT team)
//		  , maximumCacheSize(1024 * 1024 * 128) //1st cache size is 128MB (for multi cache exp.)
		  , maximumCacheSize(1024 * 1024 * 4)
        , currentCacheSize(-1)
        {}
    ...
    QString cacheDirectory;
	 QString migrateDirectory; /*[sslab cache]*/
	 bool lastCache;				/*[sslab cache]*/
