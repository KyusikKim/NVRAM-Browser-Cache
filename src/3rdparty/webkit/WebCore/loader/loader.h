...
namespace WebCore {
    ...
    private:
...
#ifdef SSLAB_SR
			void clearForReload(Request* request, SubresourceLoader*, bool cancelled = false);
#endif
		...
		//sslab.sr
		DocLoader* srDocLoader;
		CachedResource* srResource;
//		Request* srRequest;
		bool srIncremental;
		SecurityCheckPolicy srSecurityCheck;
		bool srSendResourceLoadCallbacks;
    };
