...
#ifndef SSLAB_ALLINNVRAM
#define SSLAB_ALLINNVRAM	//sslab.allinnvram
#endif
...
#ifdef SSLAB_ALLINNVRAM
QString QDesktopServices::storageLocation(StandardLocation type)
{
    if (type == QDesktopServices::HomeLocation)
		return QLatin1String("/mnt/ramdisk");
    if (type == QDesktopServices::TempLocation)
		return QLatin1String("/mnt/ramdisk/tmp");

    // http://standards.freedesktop.org/basedir-spec/basedir-spec-0.6.html
    if (type == QDesktopServices::CacheLocation) {
        QString xdgCacheHome = QLatin1String(qgetenv("XDG_CACHE_HOME"));	//what?
	 ...
	 if (type == QDesktopServices::TopCacheLocation) {	//sslab.cache
		  QString topCacheHome = QLatin1String("/mnt/ramdisk/.cache");
		  topCacheHome += QLatin1Char('/') + QCoreApplication::organizationName()
                    + QLatin1Char('/') + QCoreApplication::applicationName();
        return topCacheHome;
	 }
    ...
    if (type == QDesktopServices::DataLocation) {
        ...
        if (xdgDataHome.isEmpty())
            xdgDataHome = QLatin1String("/mnt/ramdisk/.local/share");
    ...
    case DesktopLocation:
        path = QLatin1String("/mnt/ramdisk/Desktop");
        break;
    case DocumentsLocation:
        path = QLatin1String("/mnt/ramdisk/Documents");
       break;
    case PicturesLocation:
        path = QLatin1String("/mnt/ramdisk/Pictures");
        break;

    case FontsLocation:
        path = QLatin1String("/mnt/ramdisk/.fonts");
        break;

    case MusicLocation:
        path = QLatin1String("/mnt/ramdisk/Music");
        break;

    case MoviesLocation:
        path = QLatin1String("/mnt/ramdisk/Videos");
        break;
