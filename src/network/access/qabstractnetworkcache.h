...
public:
    ...
    virtual void insert(QIODevice *device) = 0;
	 ...
	 virtual qint64 expire() = 0; /*[sslab cache]*/
	 virtual QString cacheDirectory() const = 0; /*[sslab cache]*/
	 virtual QString migrateDirectory() const = 0; /*[sslab cache]*/
	 virtual bool lastCache() const = 0; /*[sslab cache]*/
	 virtual QString _cacheFileName(const QUrl &url) const = 0; /*[sslab cache]*/
