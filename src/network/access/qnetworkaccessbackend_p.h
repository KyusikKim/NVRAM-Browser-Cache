...
public:
    ...
    QAbstractNetworkCache *networkCache() const;
	 QAbstractNetworkCache *networkTopCache() const; /*[sslab cache]*/
	 ...
	 qreal getCache1Count();
	 qreal getCache2Count();
	 qreal getRequestCount();
	 qreal cache1HitRatio();
	 qreal cache2HitRatio();
	 //cache time
	 void incCacheTime(qint64 consumeTime);
	 qint64 getCacheTime();
	 //resource loading time
	 void setResourceLoadStartTime(qint64 timestamp);
	 qint64 getResourceLoadStartTime();
	 void setResourceLoadEndTime(qint64 timestamp);
	 qint64 getResourceLoadEndTime();
	 void incResourceLoadTime(qint64 consumedTime);
	 qint64 getResourceLoadTime();
	 void incFromCacheResourceLoadTime(qint64 fromCacheTime);
	 qint64 getFromCacheResourceLoadTime();
	 void setResourceFromCache(bool loadedFromCache);
	 bool getResourceFromCache();
	 //page loading time
	 void setPageLoadStartTime(qint64 timestamp);
	 qint64 getPageLoadStartTime();
...
private:
    ...
    bool synchronous;
	 /*[sslab cache]*/
	 qint64 resourceLoadStartTime;
	 qint64 resourceLoadEndTime;
	 bool resourceFromCache;
};
