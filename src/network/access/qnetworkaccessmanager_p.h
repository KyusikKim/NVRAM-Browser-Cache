...
public:
    QNetworkAccessManagerPrivate()
        : networkCache(0), networkTopCache(0)/*[sslab cache]*/, cookieJar(0),
          ...
          cookieJarCreated(false),
		    cache1Count(0.0), cache2Count(0.0), requestCount(0.0), /*[sslab cache]*/
		    cacheTime(0), /*[sslab cache]*/
		    resourceLoadTime(0), fromCacheResourceLoadTime(0), /*[sslab cache]*/
		    pageLoadStartTime(0) /*[sslab cache]*/
    { }
    ~QNetworkAccessManagerPrivate();
    ...
    QAbstractNetworkCache *networkCache;
	 QAbstractNetworkCache *networkTopCache; /*[sslab cache]*/
    ...
    bool cookieJarCreated;
	 ...
	 qreal cache2Count;
	 qreal requestCount;
	 //consolidated cache time
	 qint64 cacheTime;
	 //consolidated resource load time
	 qint64 resourceLoadTime;
	 qint64 fromCacheResourceLoadTime;
	 //page load time (need re-imp.)
	 qint64 pageLoadStartTime;
