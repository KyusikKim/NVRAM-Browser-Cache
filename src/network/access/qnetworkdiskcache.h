...
public:
    ...
    void setCacheDirectory(const QString &cacheDir);
	 ...
	 QString migrateDirectory() const;	/*[sslab cache]*/
	 void setMigrateDirectory(const QString &cacheDir);	/*[sslab cache]*/

	 bool lastCache() const;	/*[sslab cache]*/
	 void setLastCache(bool last);	/*[sslab cache]*/
	 QString _cacheFileName(const QUrl &url) const; /*[sslab cache]*/
